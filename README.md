...
- **빠른 날짜 선택** - 캘린더 제목 클릭 시 월/일 선택 모달, 연도 클릭 시 연도 그리드(12개 연도 한눈에 선택)
- **효율적인 네비게이션** - 기존 화살표 버튼 + 날짜 선택 모달로 년/월/일 한 번에 이동
...
- **캘린더 네비게이션**
  - **◀ / ▶ 버튼** - 이전/다음 월 이동
  - **제목 클릭 ("2026년 4월")** - 날짜 선택 모달 열기 (월/일 선택)
  - **연도 클릭 ("2026년")** - 연도 그리드 보기 (12개 연도 중 선택, 10년 단위 이동)
  - **오늘 버튼** - 현재 날짜로 이동
